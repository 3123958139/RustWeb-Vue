    ...
    <div class="fj200c_main-root">
      <div class="fm-page">
        <div class="fm-panel help-panel">
          ...
          <div v-loading="loading" class="fm-panel-body">
...
import ScaledPage from '@/ftj1c/components/ScaledPage.vue'
...
onMounted(async () => {
  try {
    const response = await ftj1cApi.getHelp()
