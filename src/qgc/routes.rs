...
pub fn qgc_router(db: DatabaseConnection) -> Router<DatabaseConnection> {
    ...
    let protected = Router::<DatabaseConnection>::new()
        ...
        .route("/param", get(handlers::get_params_handler))
        .route("/param", put(handlers::set_param_handler))
        .route("/stream", get(handlers::get_stream_handler))
        .route("/stream", post(handlers::set_stream_handler))
        .route("/telemetry/csv", get(handlers::list_csv_handler))
        .route("/telemetry/csv/:name", get(handlers::get_csv_handler))
