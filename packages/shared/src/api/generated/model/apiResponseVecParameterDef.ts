 ...
 */
import type { ApiResponseVecParameterDefDataItem } from './apiResponseVecParameterDefDataItem';
 ...
 */
export interface ApiResponseVecParameterDef {
  data?: ApiResponseVecParameterDefDataItem[];
  /**
     * 错误信息（可选）
     * @nullable
     */
