 ...
 */
import type { ApiResponseVecQgcCsvFileDataItem } from './apiResponseVecQgcCsvFileDataItem';
 ...
 */
export interface ApiResponseVecQgcCsvFile {
  data?: ApiResponseVecQgcCsvFileDataItem[];
  /**
     * 错误信息（可选）
     * @nullable
     */
