 ...
 */
import type { ApiResponseQgcStreamResponseData } from './apiResponseQgcStreamResponseData';
 ...
 */
export interface ApiResponseQgcStreamResponse {
  /** 数据流频率响应（`GET/POST /api/qgc/stream`） */
  data?: ApiResponseQgcStreamResponseData;
  /**
     * 错误信息（可选）
     * @nullable
     */
