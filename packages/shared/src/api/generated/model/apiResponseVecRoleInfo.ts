 ...
 */
import type { ApiResponseVecRoleInfoDataItem } from './apiResponseVecRoleInfoDataItem';
 ...
 */
export interface ApiResponseVecRoleInfo {
  data?: ApiResponseVecRoleInfoDataItem[];
  /**
     * 错误信息（可选）
     * @nullable
     */
