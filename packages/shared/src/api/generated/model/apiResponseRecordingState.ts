 ...
 */
import type { ApiResponseRecordingStateData } from './apiResponseRecordingStateData';
 ...
 */
export interface ApiResponseRecordingState {
  /** CSV 录制状态响应 */
  data?: ApiResponseRecordingStateData;
  /**
     * 错误信息（可选）
     * @nullable
     */
