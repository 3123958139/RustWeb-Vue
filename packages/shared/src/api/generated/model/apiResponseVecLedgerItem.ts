 ...
 */
import type { ApiResponseVecLedgerItemDataItem } from './apiResponseVecLedgerItemDataItem';
 ...
 */
export interface ApiResponseVecLedgerItem {
  data?: ApiResponseVecLedgerItemDataItem[];
  /**
     * 错误信息（可选）
     * @nullable
     */
