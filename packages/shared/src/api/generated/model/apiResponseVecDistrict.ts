 ...
 */
import type { ApiResponseVecDistrictDataItem } from './apiResponseVecDistrictDataItem';
 ...
 */
export interface ApiResponseVecDistrict {
  data?: ApiResponseVecDistrictDataItem[];
  /**
     * 错误信息（可选）
     * @nullable
     */
