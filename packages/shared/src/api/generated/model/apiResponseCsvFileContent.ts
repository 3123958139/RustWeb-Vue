 ...
 */
import type { ApiResponseCsvFileContentData } from './apiResponseCsvFileContentData';
 ...
 */
export interface ApiResponseCsvFileContent {
  /** CSV 文件内容 */
  data?: ApiResponseCsvFileContentData;
  /**
     * 错误信息（可选）
     * @nullable
     */
