 ...
 */
import type { ApiResponseSimulationStateData } from './apiResponseSimulationStateData';
 ...
 */
export interface ApiResponseSimulationState {
  /** 模拟运行状态响应 */
  data?: ApiResponseSimulationStateData;
  /**
     * 错误信息（可选）
     * @nullable
     */
