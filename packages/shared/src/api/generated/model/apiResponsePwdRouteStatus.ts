 ...
 */
import type { ApiResponsePwdRouteStatusData } from './apiResponsePwdRouteStatusData';
 ...
 */
export interface ApiResponsePwdRouteStatus {
  /** 初始密码查询路由停用状态 */
  data?: ApiResponsePwdRouteStatusData;
  /**
     * 错误信息（可选）
     * @nullable
     */
